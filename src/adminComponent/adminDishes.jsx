...
const AdminDishes = () => {
  ...
  const DishCard = ({ dish, categoryId, categoryName }) => (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex space-x-2">
          <button
            onClick={() => navigate(`/admin-dishes/edit/${categoryId}/${dish._id}`)}
  ...
  const noDishes = categories.length === 0 || categories.every((category) => category.dishes.length === 0)
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Manage your wedding menu with our comprehensive dish management system. Add, edit, and organize delicious
            dishes for your special day.
          </p>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          {noDishes ? (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">No dishes available</h3>
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                Start building your wedding menu by adding your first delicious dish.
              </p>
              <button
                onClick={() => navigate("/admin-dishes/addDishes")}

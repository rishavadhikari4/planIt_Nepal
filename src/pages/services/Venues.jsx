    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-100 relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
              ...
              <div className="flex gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-16 pr-6 py-5 text-lg bg-gray-50/70 border-2 border-gray-200/60 rounded-2xl focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 transition-all duration-300 text-gray-800 placeholder-gray-500 shadow-sm"
                  />
                </div>
                <motion.button
                  onClick={handleSearch}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-10 py-5 rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-3 text-lg"
        ...
        <div className="max-w-7xl mx-auto">
          {venues.length === 0 ? (
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-gray-800 mb-4">No Venues Found</h3>
        ...
        {venues.length > 0 && (
          ...
          >
            <motion.div
              className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-purple-500/10 border border-white/30 p-10 max-w-2xl mx-auto"

        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-br from-white to-purple-50 shadow-2xl rounded-2xl p-8 sm:p-10 border border-purple-100/50">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Help other couples by sharing your wedding story</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Share your thoughts about our service, venue, food, decorations, or overall experience..."
                  rows={5}
                  required
                />
              </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-gradient-to-br from-white to-purple-50 shadow-xl rounded-2xl p-8 sm:p-10 border border-purple-100/50">
            ...
            <p className="text-lg text-gray-600 mb-6">
              ...
              to leave a review and share your experience.
            </p>
            <button
              onClick={() => (window.location.href = "/login")}
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 px-8 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Login to Review
            </button>
          </div>

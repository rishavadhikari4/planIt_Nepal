...
import { ArrowLeft, Camera, FileText, Upload, X, ImageIcon, Plus, Banknote, MapPin, Tag } from "lucide-react"
...
const Addstudio = () => {
  ...
  // Valid services as per backend validation
  const validServices = [
    'Wedding Photography',
    'Pre-wedding Shoot', 
    'Video Recording',
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!formData.name || !formData.location || !formData.description || !formData.price || !imageFile) {
      ...
      >
        ...
        <div className="mb-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-gray-600">Create a new professional photography studio</p>
          </div>
        </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Describe the studio features and specialties"
                    required
                    rows={5}
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 mt-2">Select all services this studio offers</p>
                </motion.div>
              </div>

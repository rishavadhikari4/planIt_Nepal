      ...
      <div className="max-w-4xl mx-auto px-4 lg:px-6">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Update your decoration information and details</p>
          </div>
        </motion.div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={8}
                    placeholder="Describe your decoration..."
        ...
        >
          <p>Make sure all information is accurate before updating the decoration.</p>
        </motion.div>
      </div>
    </div>
  )
